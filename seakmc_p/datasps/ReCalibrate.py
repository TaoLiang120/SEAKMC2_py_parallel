...
def recalib_energy_single(itask_start, thiscolor, comm_split,
    ...
    if thisRecal:
        ...
        [thisesp, coords, isValid, errormsg] = force_evaluator.run_runner("RECAL", thisdata, thiscolor,
        ...
        if ReBias:
            ...
            [thisefin, coords, isValid, errormsg] = force_evaluator.run_runner("RECAL", thisdata, thiscolor,
